...
class LunchFragment : Fragment(), MessMenuInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        items = inflater.inflate(R.layout.fragment_lunch, container, false)
    ...
    private fun getMenuDetails(items: View) {
        val menu = items.findViewById<RecyclerView>(R.id.lunch_recycler_view)
        menu.layoutManager = LinearLayoutManager(context)
        val data = MessMenuActivity.MessMenuData?.lunch ?: arrayOf("Lunch menu not available")
