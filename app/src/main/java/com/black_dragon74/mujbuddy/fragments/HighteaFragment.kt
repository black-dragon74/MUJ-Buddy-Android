...
class HighteaFragment : Fragment(), MessMenuInterface {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        items = inflater.inflate(R.layout.fragment_hightea, container, false)
    ...
    private fun getMenuDetails(items: View) {
        val menu = items.findViewById<RecyclerView>(R.id.hightea_recycler_view)
        menu.layoutManager = LinearLayoutManager(context)
        val data = MessMenuActivity.MessMenuData?.high_tea ?: arrayOf("High tea menu not available")
